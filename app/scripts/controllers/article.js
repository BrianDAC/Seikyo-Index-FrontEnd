...
.controller('ArticleCtrl', function ($scope, Modal, API, $rootScope, $animate, $mdSidenav, $state, SeikyoResource, articles) {
	var monthNames = ["January", "February", "March", "April", "May", "June",
	  "July", "August", "September", "October", "November", "December"
	];
	for (var i = 0; i < articles.length; i++) {
		var d = new Date(articles[i].seikyo.date);
		articles[i].seikyo.date = monthNames[d.getMonth()]
	};
