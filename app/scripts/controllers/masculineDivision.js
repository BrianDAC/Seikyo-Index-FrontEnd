...
.controller('MasculineDivisionCtrl', function ($scope, Modal, API, $rootScope, $animate, $mdSidenav, $state, SeikyoResource, masculineDivisions) {
	var monthNames = ["January", "February", "March", "April", "May", "June",
	  "July", "August", "September", "October", "November", "December"
	];
	for (var i = 0; i < masculineDivisions.length; i++) {
		var d = new Date(masculineDivisions[i].seikyo.date);
		masculineDivisions[i].seikyo.date = monthNames[d.getMonth()]
	};
	$scope.masculineDivisions = masculineDivisions
