...
.controller('FemenineDivisionCtrl', function ($scope, Modal, API, $rootScope, $animate, $mdSidenav, $state, SeikyoResource, femenineDivisions) {
	var monthNames = ["January", "February", "March", "April", "May", "June",
	  "July", "August", "September", "October", "November", "December"
	];
	for (var i = 0; i < femenineDivisions.length; i++) {
		var d = new Date(femenineDivisions[i].seikyo.date);
		femenineDivisions[i].seikyo.date = monthNames[d.getMonth()]
	};
	$scope.femenineDivisions = femenineDivisions
