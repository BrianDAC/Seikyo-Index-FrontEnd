...
.controller('MessageCtrl', function ($scope, Modal, API, $rootScope, $animate, $mdSidenav, $state, SeikyoResource, messages) {
	var monthNames = ["January", "February", "March", "April", "May", "June",
	  "July", "August", "September", "October", "November", "December"
	];
	for (var i = 0; i < messages.length; i++) {
		var d = new Date(messages[i].seikyo.date);
		messages[i].seikyo.date = monthNames[d.getMonth()]
	};
