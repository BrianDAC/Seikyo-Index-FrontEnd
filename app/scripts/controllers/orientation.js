...
.controller('OrientationCtrl', function ($scope, Modal, API, $rootScope, $animate, $mdSidenav, $state, SeikyoResource, orientations) {
	var monthNames = ["January", "February", "March", "April", "May", "June",
	  "July", "August", "September", "October", "November", "December"
	];
	for (var i = 0; i < orientations.length; i++) {
		var d = new Date(orientations[i].seikyo.date);
		orientations[i].seikyo.date = monthNames[d.getMonth()]
	};
