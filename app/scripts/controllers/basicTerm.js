...
.controller('BasicTermCtrl', function ($scope, Modal, API, $rootScope, $animate, $mdSidenav, $state, SeikyoResource, basicTerms) {
	var monthNames = ["January", "February", "March", "April", "May", "June",
	  "July", "August", "September", "October", "November", "December"
	];
	for (var i = 0; i < basicTerms.length; i++) {
		var d = new Date(basicTerms[i].seikyo.date);
		basicTerms[i].seikyo.date = monthNames[d.getMonth()]
	};
	$scope.basicTerms = basicTerms
