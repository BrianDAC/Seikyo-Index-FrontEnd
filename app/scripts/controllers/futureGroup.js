...
.controller('FutureGroupCtrl', function ($scope, Modal, API, $rootScope, $animate, $mdSidenav, $state, SeikyoResource, futureGroups) {
	var monthNames = ["January", "February", "March", "April", "May", "June",
	  "July", "August", "September", "October", "November", "December"
	];
	for (var i = 0; i < futureGroups.length; i++) {
		var d = new Date(futureGroups[i].seikyo.date);
		futureGroups[i].seikyo.date = monthNames[d.getMonth()]
	};
