...
.controller('SokaAdvanceCtrl', function ($scope, Modal, API, $rootScope, $animate, $mdSidenav, $state, SeikyoResource, sokaAdvances) {
	var monthNames = ["January", "February", "March", "April", "May", "June",
	  "July", "August", "September", "October", "November", "December"
	];
	console.log(sokaAdvances)
	for (var i = 0; i < sokaAdvances.length; i++) {
		var d = new Date(sokaAdvances[i].seikyo.date);
		sokaAdvances[i].seikyo.date = monthNames[d.getMonth()]
	};
	$scope.sokaAdvances = sokaAdvances
