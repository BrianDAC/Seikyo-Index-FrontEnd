...
.controller('ExperienceCtrl', function ($scope, Modal, API, $rootScope, $animate, $mdSidenav, $state, SeikyoResource, experiences) {
	var monthNames = ["January", "February", "March", "April", "May", "June",
	  "July", "August", "September", "October", "November", "December"
	];
	for (var i = 0; i < experiences.length; i++) {
		var d = new Date(experiences[i].seikyo.date);
		experiences[i].seikyo.date = monthNames[d.getMonth()]
	};
