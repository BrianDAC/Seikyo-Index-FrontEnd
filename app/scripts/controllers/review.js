...
.controller('ReviewCtrl', function ($scope, Modal, API, $rootScope, $animate, $mdSidenav, $state, SeikyoResource, reviews) {
	var monthNames = ["January", "February", "March", "April", "May", "June",
	  "July", "August", "September", "October", "November", "December"
	];
	for (var i = 0; i < reviews.length; i++) {
		var d = new Date(reviews[i].seikyo.date);
		reviews[i].seikyo.date = monthNames[d.getMonth()]
	};
