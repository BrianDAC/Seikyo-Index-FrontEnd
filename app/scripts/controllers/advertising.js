...
.controller('AdvertisingCtrl', function ($scope, Modal, API, $rootScope, $animate, $mdSidenav, $state, SeikyoResource, advertisings) {
	var monthNames = ["January", "February", "March", "April", "May", "June",
	  "July", "August", "September", "October", "November", "December"
	];
	for (var i = 0; i < advertisings.length; i++) {
		var d = new Date(advertisings[i].seikyo.date);
		advertisings[i].seikyo.date = monthNames[d.getMonth()]
	};
	$scope.advertisings = advertisings
