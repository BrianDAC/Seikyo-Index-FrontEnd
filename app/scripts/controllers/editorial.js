...
.controller('EditorialCtrl', function ($scope, Modal, API, $rootScope, $animate, $mdSidenav, $state, SeikyoResource, editorials) {
	var monthNames = ["January", "February", "March", "April", "May", "June",
	  "July", "August", "September", "October", "November", "December"
	];
	for (var i = 0; i < editorials.length; i++) {
		var d = new Date(editorials[i].seikyo.date);
		editorials[i].seikyo.date = monthNames[d.getMonth()]
	};
	$scope.editorials = editorials
